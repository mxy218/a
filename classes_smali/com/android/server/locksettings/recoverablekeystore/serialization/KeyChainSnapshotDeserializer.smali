...
.method private static deserializeInternal(Ljava/io/InputStream;)Landroid/security/keystore/recovery/KeyChainSnapshot;
    ...
    :try_end_c8
    .catch Ljava/security/cert/CertificateException; {:try_start_c1 .. :try_end_c8} :catch_c9
    ...
    move-result-object v0
    :try_end_106
    .catch Ljava/lang/NullPointerException; {:try_start_102 .. :try_end_106} :catch_107
    ...
    :sswitch_data_112
    .sparse-switch
        -0x66841336 -> :sswitch_91
        -0x52c1d0fe -> :sswitch_87
        -0x51ae5e2f -> :sswitch_7f
        -0x5190b3fe -> :sswitch_77
        0x1caf9a74 -> :sswitch_6f
        0x46f25222 -> :sswitch_64
        0x5099d037 -> :sswitch_5c
        0x5f2e61bf -> :sswitch_51
        0x6bb456a9 -> :sswitch_4a
    .end sparse-switch
...
.method private static readKeyChainProtectionParams(Lorg/xmlpull/v1/XmlPullParser;)Landroid/security/keystore/recovery/KeyChainProtectionParams;
    ...
    move-result-object v1
    :try_end_91
    .catch Ljava/lang/NullPointerException; {:try_start_8d .. :try_end_91} :catch_92
...
.method private static readWrappedApplicationKey(Lorg/xmlpull/v1/XmlPullParser;)Landroid/security/keystore/recovery/WrappedApplicationKey;
    ...
    move-result-object v1
    :try_end_8f
    .catch Ljava/lang/NullPointerException; {:try_start_8b .. :try_end_8f} :catch_90
