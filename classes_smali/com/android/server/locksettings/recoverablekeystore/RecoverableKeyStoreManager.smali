...
.method public static declared-synchronized getInstance(Landroid/content/Context;Landroid/security/KeyStore;)Lcom/android/server/locksettings/recoverablekeystore/RecoverableKeyStoreManager;
    ...
    move-result-object v0
    :try_end_16
    .catch Ljava/security/NoSuchAlgorithmException; {:try_start_e .. :try_end_16} :catch_56
    .catch Ljava/security/KeyStoreException; {:try_start_e .. :try_end_16} :catch_49
    .catchall {:try_start_e .. :try_end_16} :catchall_63
    ...
    sget-object v0, Lcom/android/server/locksettings/recoverablekeystore/RecoverableKeyStoreManager;->mInstance:Lcom/android/server/locksettings/recoverablekeystore/RecoverableKeyStoreManager;
    :try_end_61
    .catchall {:try_start_17 .. :try_end_61} :catchall_63
...
.method private recoverApplicationKeys([BLjava/util/List;)Ljava/util/Map;
    ...
    :try_end_2c
    .catch Ljava/security/NoSuchAlgorithmException; {:try_start_25 .. :try_end_2c} :catch_7c
    .catch Ljava/security/InvalidKeyException; {:try_start_25 .. :try_end_2c} :catch_44
    .catch Ljavax/crypto/AEADBadTagException; {:try_start_25 .. :try_end_2c} :catch_2e
...
.method public importKeyWithMetadata(Ljava/lang/String;[B[B)Ljava/lang/String;
    ...
    move-result-object v2
    :try_end_37
    .catch Ljava/security/KeyStoreException; {:try_start_24 .. :try_end_37} :catch_38
    .catch Ljava/security/InvalidKeyException; {:try_start_24 .. :try_end_37} :catch_38
    .catch Lcom/android/server/locksettings/recoverablekeystore/RecoverableKeyStorageException; {:try_start_24 .. :try_end_37} :catch_38
...
.method initRecoveryService(Ljava/lang/String;[B)V
    ...
    move-result-object v0
    :try_end_82
    .catch Lcom/android/server/locksettings/recoverablekeystore/certificate/CertParsingException; {:try_start_7e .. :try_end_82} :catch_18e
    ...
    move-result-object v0
    :try_end_de
    .catch Lcom/android/server/locksettings/recoverablekeystore/certificate/CertValidationException; {:try_start_d5 .. :try_end_de} :catch_178
    ...
    iget-object v0, v1, Lcom/android/server/locksettings/recoverablekeystore/RecoverableKeyStoreManager;->mDatabase:Lcom/android/server/locksettings/recoverablekeystore/storage/RecoverableKeyStoreDb;
    :try_end_f1
    .catch Ljava/security/cert/CertificateEncodingException; {:try_start_e0 .. :try_end_f1} :catch_15e
    ...
    throw v2
    :try_end_15c
    .catch Ljava/security/cert/CertificateEncodingException; {:try_start_101 .. :try_end_15c} :catch_15c
...
.method public startRecoverySessionWithCertPath(Ljava/lang/String;Ljava/lang/String;Landroid/security/keystore/recovery/RecoveryCertPath;[B[BLjava/util/List;)[B
    ...
    move-result-object v0
    :try_end_3c
    .catch Ljava/security/cert/CertificateException; {:try_start_38 .. :try_end_3c} :catch_89
    ...
    :try_end_47
    .catch Lcom/android/server/locksettings/recoverablekeystore/certificate/CertValidationException; {:try_start_3e .. :try_end_47} :catch_77
