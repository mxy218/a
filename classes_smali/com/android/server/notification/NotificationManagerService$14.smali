...
.method constructor <init>(Lcom/android/server/notification/NotificationManagerService;Lcom/android/server/notification/ManagedServices$ManagedServiceInfo;IILjava/lang/String;IIIIZLjava/lang/String;)V
    ...
    iput p6, p0, Lcom/android/server/notification/NotificationManagerService$14;->val$userId:I

    iput p7, p0, Lcom/android/server/notification/NotificationManagerService$14;->val$mustHaveFlags:I

    iput p8, p0, Lcom/android/server/notification/NotificationManagerService$14;->val$mustNotHaveFlags:I

    iput p9, p0, Lcom/android/server/notification/NotificationManagerService$14;->val$reason:I

    iput-boolean p10, p0, Lcom/android/server/notification/NotificationManagerService$14;->val$doit:Z

    iput-object p11, p0, Lcom/android/server/notification/NotificationManagerService$14;->val$channelId:Ljava/lang/String;
...
.method public run()V
    ...
    iget v5, v1, Lcom/android/server/notification/NotificationManagerService$14;->val$userId:I

    iget v6, v1, Lcom/android/server/notification/NotificationManagerService$14;->val$mustHaveFlags:I

    iget v7, v1, Lcom/android/server/notification/NotificationManagerService$14;->val$mustNotHaveFlags:I

    iget v8, v1, Lcom/android/server/notification/NotificationManagerService$14;->val$reason:I
    ...
    .line 7226
    iget-boolean v0, v1, Lcom/android/server/notification/NotificationManagerService$14;->val$doit:Z
    ...
    .line 7231
    :try_start_2a
    iget v0, v1, Lcom/android/server/notification/NotificationManagerService$14;->val$mustHaveFlags:I

    iget v3, v1, Lcom/android/server/notification/NotificationManagerService$14;->val$mustNotHaveFlags:I

    new-instance v4, Lcom/android/server/notification/-$$Lambda$NotificationManagerService$14$hWnH6mjUAxwVmpU3QRoPHh5_FyI;

    invoke-direct {v4, v0, v3}, Lcom/android/server/notification/-$$Lambda$NotificationManagerService$14$hWnH6mjUAxwVmpU3QRoPHh5_FyI;-><init>(II)V

    move-object/from16 v17, v4

    .line 7240
    .local v17, "flagChecker":Lcom/android/server/notification/NotificationManagerService$FlagChecker;
    iget-object v10, v1, Lcom/android/server/notification/NotificationManagerService$14;->this$0:Lcom/android/server/notification/NotificationManagerService;

    iget-object v0, v1, Lcom/android/server/notification/NotificationManagerService$14;->this$0:Lcom/android/server/notification/NotificationManagerService;

    iget-object v11, v0, Lcom/android/server/notification/NotificationManagerService;->mNotificationList:Ljava/util/ArrayList;

    iget v12, v1, Lcom/android/server/notification/NotificationManagerService$14;->val$callingUid:I

    iget v13, v1, Lcom/android/server/notification/NotificationManagerService$14;->val$callingPid:I

    iget-object v14, v1, Lcom/android/server/notification/NotificationManagerService$14;->val$pkg:Ljava/lang/String;

    const/4 v15, 0x1

    iget-object v0, v1, Lcom/android/server/notification/NotificationManagerService$14;->val$channelId:Ljava/lang/String;

    const/16 v18, 0x0

    iget v3, v1, Lcom/android/server/notification/NotificationManagerService$14;->val$userId:I

    const/16 v20, 0x0

    iget v4, v1, Lcom/android/server/notification/NotificationManagerService$14;->val$reason:I
    ...
    iget v4, v1, Lcom/android/server/notification/NotificationManagerService$14;->val$callingUid:I

    iget v5, v1, Lcom/android/server/notification/NotificationManagerService$14;->val$callingPid:I

    iget-object v6, v1, Lcom/android/server/notification/NotificationManagerService$14;->val$pkg:Ljava/lang/String;

    const/16 v29, 0x1

    iget-object v7, v1, Lcom/android/server/notification/NotificationManagerService$14;->val$channelId:Ljava/lang/String;

    const/16 v32, 0x0

    iget v8, v1, Lcom/android/server/notification/NotificationManagerService$14;->val$userId:I
