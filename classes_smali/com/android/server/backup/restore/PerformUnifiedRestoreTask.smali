...
.method public constructor <init>(Lcom/android/server/backup/UserBackupManagerService;Lcom/android/server/backup/transport/TransportClient;Landroid/app/backup/IRestoreObserver;Landroid/app/backup/IBackupManagerMonitor;JLandroid/content/pm/PackageInfo;IZ[Ljava/lang/String;Lcom/android/server/backup/internal/OnTaskFinishedListener;)V
    ...
    :try_end_e3
    .catch Landroid/content/pm/PackageManager$NameNotFoundException; {:try_start_b0 .. :try_end_e3} :catch_e4
    ...
    :try_end_103
    .catch Landroid/content/pm/PackageManager$NameNotFoundException; {:try_start_f3 .. :try_end_103} :catch_104
    ...
    invoke-interface {v0, v2}, Ljava/util/List;->add(Ljava/lang/Object;)Z
    :try_end_117
    .catch Landroid/content/pm/PackageManager$NameNotFoundException; {:try_start_107 .. :try_end_117} :catch_118
...
.method private dispatchNextRestore()V
    ...
    :try_end_34
    .catch Ljava/lang/Exception; {:try_start_9 .. :try_end_34} :catch_1ea
    .catchall {:try_start_9 .. :try_end_34} :catchall_1e8
    ...
    :try_end_64
    .catch Ljava/lang/Exception; {:try_start_38 .. :try_end_64} :catch_1ea
    .catchall {:try_start_38 .. :try_end_64} :catchall_1e8
    ...
    :try_end_ad
    .catch Ljava/lang/Exception; {:try_start_68 .. :try_end_ad} :catch_1ea
    .catchall {:try_start_68 .. :try_end_ad} :catchall_1e8
    ...
    :try_end_c2
    .catch Landroid/content/pm/PackageManager$NameNotFoundException; {:try_start_b2 .. :try_end_c2} :catch_1b2
    .catch Ljava/lang/Exception; {:try_start_b2 .. :try_end_c2} :catch_1ea
    .catchall {:try_start_b2 .. :try_end_c2} :catchall_1e8
    ...
    :try_end_d5
    .catch Ljava/lang/Exception; {:try_start_c3 .. :try_end_d5} :catch_1ea
    .catchall {:try_start_c3 .. :try_end_d5} :catchall_1e8
    ...
    :try_end_141
    .catch Ljava/lang/Exception; {:try_start_e4 .. :try_end_141} :catch_1ea
    .catchall {:try_start_e4 .. :try_end_141} :catchall_1e8
    ...
    :try_end_193
    .catch Ljava/lang/Exception; {:try_start_145 .. :try_end_193} :catch_1ea
    .catchall {:try_start_145 .. :try_end_193} :catchall_1e8
    ...
    sget-object v2, Lcom/android/server/backup/restore/UnifiedRestoreState;->RUNNING_QUEUE:Lcom/android/server/backup/restore/UnifiedRestoreState;
    :try_end_1ae
    .catch Ljava/lang/Exception; {:try_start_198 .. :try_end_1ae} :catch_1ea
    .catchall {:try_start_198 .. :try_end_1ae} :catchall_1e8
    ...
    sget-object v2, Lcom/android/server/backup/restore/UnifiedRestoreState;->RUNNING_QUEUE:Lcom/android/server/backup/restore/UnifiedRestoreState;
    :try_end_1e4
    .catch Ljava/lang/Exception; {:try_start_1b3 .. :try_end_1e4} :catch_1ea
    .catchall {:try_start_1b3 .. :try_end_1e4} :catchall_1e8
    ...
    sget-object v2, Lcom/android/server/backup/restore/UnifiedRestoreState;->FINAL:Lcom/android/server/backup/restore/UnifiedRestoreState;
    :try_end_20c
    .catchall {:try_start_1eb .. :try_end_20c} :catchall_1e8
...
.method private startRestore()V
    ...
    invoke-virtual {p0, v0}, Lcom/android/server/backup/restore/PerformUnifiedRestoreTask;->executeNextState(Lcom/android/server/backup/restore/UnifiedRestoreState;)V
    :try_end_143
    .catch Ljava/lang/Exception; {:try_start_1a .. :try_end_143} :catch_146
...
.method initiateOneRestore(Landroid/content/pm/PackageInfo;J)V
    ...
    :try_end_195
    .catch Ljava/lang/Exception; {:try_start_8f .. :try_end_195} :catch_196
