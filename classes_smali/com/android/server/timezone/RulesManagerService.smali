...
.method private getRulesStateInternal()Landroid/app/timezone/RulesState;
    ...
    move-result-object v0
    :try_end_7
    .catch Ljava/io/IOException; {:try_start_1 .. :try_end_7} :catch_6e
    .catchall {:try_start_1 .. :try_end_7} :catchall_6c
    ...
    :try_end_1f
    .catch Lcom/android/timezone/distro/DistroException; {:try_start_a .. :try_end_1f} :catch_21
    .catch Ljava/io/IOException; {:try_start_a .. :try_end_1f} :catch_21
    .catchall {:try_start_a .. :try_end_1f} :catchall_6c
    ...
    move-result v3
    :try_end_30
    .catchall {:try_start_22 .. :try_end_30} :catchall_6c
    ...
    :try_end_50
    .catch Lcom/android/timezone/distro/DistroException; {:try_start_34 .. :try_end_50} :catch_52
    .catch Ljava/io/IOException; {:try_start_34 .. :try_end_50} :catch_52
    .catchall {:try_start_34 .. :try_end_50} :catchall_6c
    ...
    iget-object v7, v0, Llibcore/timezone/TzDataSetVersion;->rulesVersion:Ljava/lang/String;
    ...
    monitor-exit p0
    :try_end_7b
    .catchall {:try_start_53 .. :try_end_7b} :catchall_6c
...
.method protected dump(Ljava/io/FileDescriptor;Ljava/io/PrintWriter;[Ljava/lang/String;)V
    ...
    invoke-static {v8}, Lcom/android/server/timezone/RulesManagerService;->distroStatusToString(I)Ljava/lang/String;
    ...
    const-string v9, "Current install state: "
    ...
    const-string v9, "Base rules version: "
    ...
    invoke-virtual {v8}, Llibcore/timezone/ZoneInfoDB$TzData;->getVersion()Ljava/lang/String;
    ...
    invoke-virtual {v8}, Llibcore/timezone/TimeZoneFinder;->getIanaVersion()Ljava/lang/String;
    ...
    const-string v9, "Operation in progress: "
    ...
    .line 497
    .local v8, "stagedOperationType":I
    invoke-static {v8}, Lcom/android/server/timezone/RulesManagerService;->stagedOperationToString(I)Ljava/lang/String;

    move-result-object v7

    .line 499
    .end local v8  # "stagedOperationType":I
    :cond_ff
    new-instance v8, Ljava/lang/StringBuilder;

    invoke-direct {v8}, Ljava/lang/StringBuilder;-><init>()V

    const-string v9, "Staged operation: "
    ...
    .line 509
    .local v8, "stagedDistroRulesVersion":Landroid/app/timezone/DistroRulesVersion;
    if-nez v8, :cond_122
    ...
    .line 512
    :cond_122
    invoke-virtual {v8}, Landroid/app/timezone/DistroRulesVersion;->toDumpString()Ljava/lang/String;

    move-result-object v7

    .line 515
    .end local v8  # "stagedDistroRulesVersion":Landroid/app/timezone/DistroRulesVersion;
    :cond_126
    :goto_126
    new-instance v8, Ljava/lang/StringBuilder;
    ...
    const-string v9, "Staged rules version: "
    ...
    .line 483
    .local v8, "installedRulesVersion":Landroid/app/timezone/DistroRulesVersion;
    if-nez v8, :cond_149
    ...
    .line 489
    .end local v8  # "installedRulesVersion":Landroid/app/timezone/DistroRulesVersion;
    :cond_14d
    :goto_14d
    new-instance v8, Ljava/lang/StringBuilder;
    ...
    const-string v9, "Installed rules version: "
    ...
    const-string v4, "RulesManagerService state: "
    ...
    invoke-virtual {v1}, Llibcore/timezone/ZoneInfoDB$TzData;->getVersion()Ljava/lang/String;
...
.method public requestInstall(Landroid/os/ParcelFileDescriptor;[BLandroid/app/timezone/ICallback;)I
    ...
    monitor-enter p0
    :try_end_18
    .catchall {:try_start_1 .. :try_end_18} :catchall_6c
    ...
    monitor-exit p0
    :try_end_26
    .catchall {:try_start_1c .. :try_end_26} :catchall_69
    ...
    monitor-exit p0
    :try_end_48
    .catchall {:try_start_36 .. :try_end_48} :catchall_69
...
.method public requestUninstall([BLandroid/app/timezone/ICallback;)I
    ...
    monitor-exit p0
    :try_end_40
    .catchall {:try_start_18 .. :try_end_40} :catchall_35
