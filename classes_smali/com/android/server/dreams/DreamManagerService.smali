...
.method private getWallpaperPackagename()Ljava/lang/String;
    .registers 4

    .line 710
    invoke-virtual {p0}, Lcom/android/server/dreams/DreamManagerService;->getContext()Landroid/content/Context;
...
.method private shouldDream()Z
    ...
    const-string/jumbo v6, "set_wallpaper_simultaneously"
    ...
    invoke-direct {p0}, Lcom/android/server/dreams/DreamManagerService;->getWallpaperPackagename()Ljava/lang/String;

    move-result-object v6

    .line 706
    .local v6, "wallpaperPackage":Ljava/lang/String;
    if-eqz v3, :cond_3e

    if-ne v4, v5, :cond_3e

    const-string v5, "com.meizu.flyme.sdkstage"
...
.method private startDreamInternal(Z)V
    ...
    invoke-direct {p0}, Lcom/android/server/dreams/DreamManagerService;->shouldDream()Z
