...
.method private adjustUriForUserAndGrantPermission(Landroid/net/Uri;Ljava/lang/String;II)Landroid/net/Uri;
    ...
    invoke-interface {v3, p3, v4, v0, v5}, Lcom/android/server/uri/UriGrantsManagerInternal;->grantUriPermissionFromIntent(ILjava/lang/String;Landroid/content/Intent;I)V
    ...
    .line 529
    invoke-virtual {p2, v3, p4}, Landroid/telephony/TelephonyManager;->getCarrierPackageNamesForIntentAndPhone(Landroid/content/Intent;I)Ljava/util/List;
    ...
    .line 532
    const-class p4, Lcom/android/server/uri/UriGrantsManagerInternal;
    ...
    invoke-interface {p4, p3, p2, v0, v5}, Lcom/android/server/uri/UriGrantsManagerInternal;->grantUriPermissionFromIntent(ILjava/lang/String;Landroid/content/Intent;I)V
    :try_end_62
    .catchall {:try_start_1d .. :try_end_62} :catchall_67
...
.method public downloadMessage(ILjava/lang/String;Ljava/lang/String;Landroid/net/Uri;Landroid/os/Bundle;Landroid/app/PendingIntent;)V
    ...
    const-string p2, " is not allowed to call downloadMessage()"
    ...
    invoke-direct {p0, p4, v1, v0, p1}, Lcom/android/server/MmsServiceBroker$BinderService;->adjustUriForUserAndGrantPermission(Landroid/net/Uri;Ljava/lang/String;II)Landroid/net/Uri;
...
.method public sendMessage(ILjava/lang/String;Landroid/net/Uri;Ljava/lang/String;Landroid/os/Bundle;Landroid/app/PendingIntent;)V
    ...
    const-string p2, " is not allowed to call sendMessage()"
    ...
    invoke-direct {p0, p3, v1, v0, p1}, Lcom/android/server/MmsServiceBroker$BinderService;->adjustUriForUserAndGrantPermission(Landroid/net/Uri;Ljava/lang/String;II)Landroid/net/Uri;
