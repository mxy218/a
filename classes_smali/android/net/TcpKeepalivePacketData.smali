...
.method public static tcpKeepalivePacket(Landroid/net/TcpKeepalivePacketDataParcelable;)Landroid/net/TcpKeepalivePacketData;
    ...
    .line 91
    :cond_1f
    new-instance p0, Landroid/net/SocketKeepalive$InvalidPacketException;

    invoke-direct {p0, v0}, Landroid/net/SocketKeepalive$InvalidPacketException;-><init>(I)V

    throw p0
    :try_end_25
    .catch Ljava/net/UnknownHostException; {:try_start_2 .. :try_end_25} :catch_25
...
.method public equals(Ljava/lang/Object;)Z
    ...
    .line 143
    iget-object v0, p0, Landroid/net/TcpKeepalivePacketData;->srcAddress:Ljava/net/InetAddress;

    iget-object v2, p1, Landroid/net/TcpKeepalivePacketData;->srcAddress:Ljava/net/InetAddress;
    ...
    iget-object v0, p0, Landroid/net/TcpKeepalivePacketData;->dstAddress:Ljava/net/InetAddress;

    iget-object v2, p1, Landroid/net/TcpKeepalivePacketData;->dstAddress:Ljava/net/InetAddress;
    ...
    iget v0, p0, Landroid/net/TcpKeepalivePacketData;->srcPort:I

    iget v2, p1, Landroid/net/TcpKeepalivePacketData;->srcPort:I

    if-ne v0, v2, :cond_4e

    iget v0, p0, Landroid/net/TcpKeepalivePacketData;->dstPort:I

    iget v2, p1, Landroid/net/TcpKeepalivePacketData;->dstPort:I
