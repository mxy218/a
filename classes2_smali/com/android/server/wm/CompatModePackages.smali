...
.method public constructor <init>(Lcom/android/server/wm/ActivityTaskManagerService;Ljava/io/File;Landroid/os/Handler;)V
    ...
    move-result v0
    :try_end_56
    .catch Lorg/xmlpull/v1/XmlPullParserException; {:try_start_32 .. :try_end_56} :catch_ca
    .catch Ljava/io/IOException; {:try_start_32 .. :try_end_56} :catch_be
    .catchall {:try_start_32 .. :try_end_56} :catchall_bb
    ...
    move-result-object v0
    :try_end_97
    .catch Lorg/xmlpull/v1/XmlPullParserException; {:try_start_62 .. :try_end_97} :catch_ca
    .catch Ljava/io/IOException; {:try_start_62 .. :try_end_97} :catch_be
    .catchall {:try_start_62 .. :try_end_97} :catchall_bb
    ...
    move-result v0
    :try_end_9f
    .catch Ljava/lang/NumberFormatException; {:try_start_9b .. :try_end_9f} :catch_a1
    .catch Lorg/xmlpull/v1/XmlPullParserException; {:try_start_9b .. :try_end_9f} :catch_ca
    .catch Ljava/io/IOException; {:try_start_9b .. :try_end_9f} :catch_be
    .catchall {:try_start_9b .. :try_end_9f} :catchall_bb
    ...
    move-result v11
    :try_end_b0
    .catch Lorg/xmlpull/v1/XmlPullParserException; {:try_start_a2 .. :try_end_b0} :catch_ca
    .catch Ljava/io/IOException; {:try_start_a2 .. :try_end_b0} :catch_be
    .catchall {:try_start_a2 .. :try_end_b0} :catchall_bb
    ...
    :try_end_c4
    .catchall {:try_start_c1 .. :try_end_c4} :catchall_bb
    ...
    invoke-virtual {v5}, Ljava/io/FileInputStream;->close()V
    :try_end_c9
    .catch Ljava/io/IOException; {:try_start_c6 .. :try_end_c9} :catch_b9
    ...
    invoke-static {v3, v2, v0}, Landroid/util/Slog;->w(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)I
    :try_end_ce
    .catchall {:try_start_cb .. :try_end_ce} :catchall_bb
    ...
    invoke-virtual {v5}, Ljava/io/FileInputStream;->close()V
    :try_end_d4
    .catch Ljava/io/IOException; {:try_start_d1 .. :try_end_d4} :catch_b9
...
.method private saveCompatModes()V
    ...
    monitor-exit v2
    :try_end_13
    .catchall {:try_start_7 .. :try_end_13} :catchall_e4
    ...
    move-result v0
    :try_end_79
    .catch Ljava/io/IOException; {:try_start_17 .. :try_end_79} :catch_d2
    ...
    move-result-object v0
    :try_end_83
    .catch Landroid/os/RemoteException; {:try_start_7f .. :try_end_83} :catch_89
    .catch Ljava/io/IOException; {:try_start_7f .. :try_end_83} :catch_85
    ...
    :try_end_b0
    .catch Ljava/io/IOException; {:try_start_8d .. :try_end_b0} :catch_d2
    ...
    :try_end_cf
    .catch Ljava/io/IOException; {:try_start_b3 .. :try_end_cf} :catch_d0
...
.method setPackageScreenCompatModeLocked(Landroid/content/pm/ApplicationInfo;I)V
    ...
    .line 349
    invoke-virtual {v12, v13, v6, v6}, Lcom/android/server/wm/ActivityStack;->ensureActivitiesVisibleLocked(Lcom/android/server/wm/ActivityRecord;IZ)V
