...
.method private checkDistroRulesNewerThanBase(Ljava/io/File;Lcom/android/timezone/distro/DistroVersion;)Z
    ...
    .line 424
    iget-object p1, p1, Llibcore/timezone/TzDataSetVersion;->rulesVersion:Ljava/lang/String;
...
.method public stageInstallWithErrorCode(Lcom/android/timezone/distro/TimeZoneDistro;)I
    ...
    :cond_45
    :try_start_45
    new-instance v2, Llibcore/timezone/TzDataSetVersion;

    iget v3, v1, Lcom/android/timezone/distro/DistroVersion;->formatMajorVersion:I

    iget v4, v1, Lcom/android/timezone/distro/DistroVersion;->formatMinorVersion:I

    iget-object v5, v1, Lcom/android/timezone/distro/DistroVersion;->rulesVersion:Ljava/lang/String;

    iget v6, v1, Lcom/android/timezone/distro/DistroVersion;->revision:I

    invoke-direct {v2, v3, v4, v5, v6}, Llibcore/timezone/TzDataSetVersion;-><init>(IILjava/lang/String;I)V
    :try_end_52
    ...
    .line 192
    :try_start_53
    invoke-static {v2}, Llibcore/timezone/TzDataSetVersion;->isCompatibleWithThisDevice(Llibcore/timezone/TzDataSetVersion;)Z
    ...
    :cond_96
    :try_start_96
    iget-object v2, p0, Lcom/android/timezone/distro/installer/TimeZoneDistroInstaller;->baseVersionFile:Ljava/io/File;

    invoke-direct {p0, v2, v1}, Lcom/android/timezone/distro/installer/TimeZoneDistroInstaller;->checkDistroRulesNewerThanBase(Ljava/io/File;Lcom/android/timezone/distro/DistroVersion;)Z
    ...
    invoke-static {v2}, Llibcore/timezone/ZoneInfoDB$TzData;->loadTzData(Ljava/lang/String;)Llibcore/timezone/ZoneInfoDB$TzData;
    ...
    :cond_ec
    :try_start_ec
    invoke-virtual {v2}, Llibcore/timezone/ZoneInfoDB$TzData;->validate()V
    :try_end_ef
    ...
    .line 221
    :try_start_ef
    invoke-virtual {v2}, Llibcore/timezone/ZoneInfoDB$TzData;->close()V
    ...
    invoke-static {p1}, Llibcore/timezone/TimeZoneFinder;->createInstance(Ljava/lang/String;)Llibcore/timezone/TimeZoneFinder;

    move-result-object p1

    .line 233
    invoke-virtual {p1}, Llibcore/timezone/TimeZoneFinder;->validate()V
    :try_end_133
    ...
    invoke-static {v2, v0, p1}, Landroid/util/Slog;->i(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)I
    :try_end_1f0
    ...
    invoke-static {v5, v0, p1}, Landroid/util/Slog;->i(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)I
    :try_end_216
